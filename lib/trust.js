 ...
 * Accepts a normalized seller object: { name, rating, ratingMax, reviewCount, yearsActive, verified }
 */
function scoreSeller(seller) {
  ...
  if (seller.reviewCount != null) {
    // volume bonus/penalty: <10 reviews is thin evidence
 ...
 * Marketplace listings: blend platform protection with seller track record when available.
 */
...
export function normalizeSeller(raw) {
  ...
  return {
    ...
    reviewCount: raw.reviewCount ?? raw.review